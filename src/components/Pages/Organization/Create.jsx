...
import { createOrganization, userOrganizationAssign } from "@_src/services/organization";
...
export const Create = () => {
    ...
    const { mutate: handleOrganizationAssign } = useMutation({
    ...
    const { mutate: handleCreateOrganization, isLoading: organizationLoading } = useMutation({
        mutationFn: createOrganization,
        onSuccess: (data) => {
            queryClient.invalidateQueries({ queryKey: ['organization'] });
            toast('new organization created!', { type: "success" })
    ...
    if(organizationLoading) {
        return (
            <div className="orgcreate-main min-h-screen bg-white w-full flex flex-col justify-center items-center xs:pl-[0px] sm:pl-[200px] mt-[50px]">
