...
export const Form9Detail = () => {
  ...
  const handleViewRemarks = () => {
    ...
    // Filter remarks for this specific form9 and sort by newest first
    const form9Remarks = event.form_remarks
      .filter(remark => 
        remark.form_type === 'form9' && // ✅ Use 'form9' as form_type
