            ...
            <Card title="Event Details:" className="w-[60%] my-4">
                <div className="w-full flex flex-col gap-4">
                    {/* <div className="flex gap-2">
                        ...
                        <p className="capitalize">{event?.activity.name}</p>
                    </div>
                    <div className="flex gap-2">
                        <h1 className="font-bold">Description:</h1>
                        <p className="capitalize">{event?.activity.description}</p>
                    </div> */}
                    {/* <div className="flex gap-2">
                    ...
                    <div className="flex gap-2">
                        <h1 className="font-bold">Budget Proposal:</h1>
                        <p className="capitalize">{event?.budget_proposal}</p>
                    </div>
                    {/* <div className="flex gap-2">
